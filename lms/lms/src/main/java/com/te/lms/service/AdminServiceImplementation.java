...
public class AdminServiceImplementation implements AdminService {
	...
	public BatchDetailsUpdateDTO getDataBatchDetails(Integer sNo) {
		...
		return mapper.map(batchDetails, BatchDetailsUpdateDTO.class);
	}
	...
	public List<BatchDetailsUpdateDTO> getAllBatchDeatils() {
		...
		if (!findAll.isEmpty()) {
			List<BatchDetailsUpdateDTO> batchDetailsUpdateDTOs = new ArrayList<>();
			findAll.forEach(i -> {
				BatchDetailsUpdateDTO batchDetailsUpdateDTO = new BatchDetailsUpdateDTO();
				mapper.map(i, batchDetailsUpdateDTO);
				batchDetailsUpdateDTOs.add(batchDetailsUpdateDTO);
			});
			return batchDetailsUpdateDTOs;
		} else {
			throw new DataNotFoundException("Data Not Found");
		}

	}
	// Register Mentor list
	@Override
...
//	}
	...
	// SearchAllData Mentor list

	@Override
	public List<MentorListDTO> getAllMentorListDetails() {
		List<MentorList> findAll = mentorListRepository.findAll();
		if (!findAll.isEmpty()) {
